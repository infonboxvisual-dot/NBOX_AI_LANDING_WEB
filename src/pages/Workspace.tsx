...
export default function Workspace() {
  ...
  const apps: AppItem[] = [
    ...
    { kind: 'app', id: 'app13', title: 'NBOX IMAGE TO 3D', descKey: 'workspace.app13.desc', icon: 'deployed_code', image: '/app/image-to-3d.webp', youtubeUrl: '', accessUrl: 'https://image-to-3d.nboxai.io/' },
  ];
